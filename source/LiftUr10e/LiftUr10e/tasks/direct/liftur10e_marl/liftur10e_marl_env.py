...
from .liftur10e_marl_env_cfg import Liftur10eMarlEnvCfg


class Liftur10eMarlEnv(DirectMARLEnv):
    cfg: Liftur10eMarlEnvCfg

    def __init__(self, cfg: Liftur10eMarlEnvCfg, render_mode: str | None = None, **kwargs):
